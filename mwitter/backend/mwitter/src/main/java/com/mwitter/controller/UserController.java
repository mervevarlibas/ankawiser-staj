...
public class UserController {
    ...
    public UserResponse registerUser(@Valid @RequestBody RegisterRequest request) {//valid registerrequest.java içindeki kurallara göre doğrulama yapıyor.requestbody Postman’dan gelen JSON’u Java nesnesine çevirir.
